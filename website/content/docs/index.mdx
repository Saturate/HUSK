---
title: Introduction
description: What YAMS is and why you need it.
---

YAMS is a self-hosted memory layer for AI coding assistants. It captures what you work on, remembers cross-project patterns, and surfaces relevant context — across all your machines and tools.
...
1. [Quick start](/docs/quick-start) — get YAMS running with Docker Compose in under a minute
